        ...
        <div className={`bg-white dark:bg-black`}>
            <div className='flex items-center justify-between mx-auto max-w-7xl h-16'>
                <div className='hover:animate-pulse flex items-center'>
                    <img src={logo} alt="logo" className='h-14 w-14 mr-2 rounded-full border border-black shadow-md'/>
                    <h1 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-black'}`}>Career<span className='text-[#0393D1]'>Hive</span></h1>
                </div>
                <div className='flex items-center gap-12'>
                    <ul className={`flex font-medium items-center gap-5 ${isDarkMode ? 'text-white' : 'text-black'}`}>
                        {
