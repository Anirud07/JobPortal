...
const categories = [
  { title: 'Frontend Developer', rating: 4.85, skills: 1853 },
  { title: 'Backend Developer', rating: 4.8, skills: 294 },
        ...
        {categories.map((category, index) => (
          ...
          >
            ...
            <div className="flex items-center mb-6">
              ...
              <span className="text-gray-600 dark:text-gray-400">{category.skills} skills</span>
            </div>
            <Button
